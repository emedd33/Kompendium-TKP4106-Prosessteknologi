...
\end{split}
\end{equation}
   Det kan hjelpe å se på benevningnene til utrykkene når du jobber med shell balance for å forstå hvordan du setter opp leddene. For at du ikke skal forvirres av ligningen går vi gjennom hvert ledd:
\begin{align*}
